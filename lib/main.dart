...
//
//
//      List<dynamic> numbers = [1, 2, 3]; // there is no List<static>
//   // numbers[0] -> 1
//   // numbers[1] -> 2
//   // numbers[2] -> 3
//
...
//    List<String> names= ["Mitch", "Koko", "Vince", "Vince"];
//
//   //LIST: under ordered collection of unique elements
//    List<String> names= ["Mitch", "Koko", "Vince"];
//
//    //FROM bezkoder
...
//   // numbers[0];
//
//   List<String> uniqueNames= ["Mitch", "Koko", "Vince", "Vince"];
//
//   // List<String> myList = List<String>(3);
//   // myList[0] = 'one';
//   // myList[1] = 'two';
